...
public class SmallTopHeapTest {
    @Test
    public void SmallTopHeapTest01(){
        ...
        AbstractBinaryHeap<Integer> heap = new SmallTopHeap<>();
    ...
    @Test
    public void SmallTopHeapTest02(){
        Integer[] integers = {60, 1, 55, 96, 5, 78, 62, 90, 20,
                72, 67, 64, 28, 95, 27, 3, 19, 33, 68, 41, 94,
                79, 38, 7, 24, 80, 9, 13, 4, 40, 11, 58, 99, 16,
                93, 71, 46, 65, 74, 76, 44, 47, 15, 99};
        ...
        BinaryTrees.println(heap);
        System.out.println("========================================================================");
        Assert.assertEquals(1, (int) heap.replace(100));
